 ...
 * Schubfach bytes directly into the output buffer, avoiding String allocation.
 * Mirrors the optimization in jackson-core PR #1657.
 */
public class PR1657JsonGenerator extends UTF8JsonGenerator {

    private static final int MAX_DOUBLE_BYTES = 24;

    public PR1657JsonGenerator(ObjectWriteContext ctxt, IOContext ioCtxt,
