...
// Verbatim copy of WriterBasedJsonGenerator from jackson-core PR #1682
// (https://github.com/FasterXML/jackson-core/pull/1682, commit 41b264e), renamed
// so it can be benchmarked side-by-side with the 3.3.0-SNAPSHOT WriterBasedJsonGenerator.
 ...
 */
public class PR1682WriterJsonGenerator
    extends JsonGeneratorBase
{
    ...
    public PR1682WriterJsonGenerator(ObjectWriteContext writeCtxt, IOContext ioCtxt,
